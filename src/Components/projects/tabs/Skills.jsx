...
const Skills = ({phoneSize, open}) => {
    ...
    const skillsArray1 = [{name: "Git", icon: <IoMdGitBranch />},
    ...
    const skillsArray2 = [{name: "Java", icon: <FaJava />},
    ...
    return (
        <div className={phoneSize ? classes.rootMobile 
        : betweenSize ? classes.root
        : largeDesktopSize ? classes.rootLarge 
        : classes.root}>
        <Grid item xs={12} md={6} className={ largeDesktopSize ? classes.gridLarge : !phoneSize ? classes.grid : !open ? classes.gridMobile : classes.gridMobileSmall}>
          {!phoneSize ? (
        ...
        <div>
            ...
            <div className={classes.gitHubInformation}>
                ...
                <p style={{color: "#d4d4dc"}}>Repos: <span style={{color: "#feda6a"}}>{gitHubInfo && gitHubInfo.public_repos}</span></p>
                <p style={{color: "#d4d4dc"}}>Followers: <span style={{color: "#feda6a"}}>{gitHubInfo && gitHubInfo.followers}</span></p>
                <p style={{color: "#d4d4dc"}}>Following: <span style={{color: "#feda6a"}}>{gitHubInfo && gitHubInfo.following}</span></p>
            </div>
        ...
        <div>
            ...
            <img className={classes.gitHubGraphMobile} src ="http://ghchart.rshah.org/sethnadu" />
        </div>
        ) : (
